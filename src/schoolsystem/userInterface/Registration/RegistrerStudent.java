...
public class RegistrerStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textPadres.setBackground(new java.awt.Color(255, 255, 255));
        ...
        textObservaciones.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!textusuario.getText().isEmpty() && !passwordField1.getText().isEmpty() && !textNombe.getText().isEmpty() && !textEdad.getText().isEmpty() && (!masculinoCheckBox.isSelected() == false || !femeninoCheckBox.isSelected() == false) && !txtCorreo.getText().isEmpty()){
                    ...
                    if(Estudiante.verificarUsuarioNuevo(textusuario.getText()) == -1){
                        Estudiante estudiante = new Estudiante(textNombe.getText(), Integer.parseInt(textEdad.getText()), sex, txtCorreo.getText(), passwordField1.getText(), textusuario.getText(), textPadres.getText(), textObservaciones.getText(), fecha);
                        ListaUsuaios.agregarEstudiante(estudiante);
