...
public class Estudiante extends Usuario{
    ...
    public Estudiante(String nombre, int edad, char genero, String correo, String contraseña, String usuario, String nombrePadres, String observaciones, String fechaIngreso) {
    ...
    public static Vector mostrar(){
        return ListaUsuaios.mostrarEstudiante();
    }
    ...
    public static int verificarUsuarioNuevo(String usuario){
        ...
        for (int i = 0; i < lista.size(); i++){
            obj = (Estudiante)lista.elementAt(i);
